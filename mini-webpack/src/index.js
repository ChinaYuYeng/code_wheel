...
function bundle(graph) {
  ...
  graph.forEach(mod => {
    //   require, module, exports，3个参数是配合babel转换出来的es5的代码所使用到的变量
    //  在打包好的js，require的功能不再是nodejs中的require，是自定义的加载指定的数字模块，exports就是一个对象用于承载导出的内容
    modules += `${mod.id}:[
...
module.exports = function startBundle(entry){
